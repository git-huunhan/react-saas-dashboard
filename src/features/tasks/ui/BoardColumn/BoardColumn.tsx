...
export function BoardColumn({ columnId, title, tasks }: BoardColumnProps) {
  return (
    <div className="flex flex-col rounded-xl border bg-zinc-50 min-w-[280px] w-[280px]">
      ...
      <Droppable droppableId={columnId}>
        {(provided, snapshot) => (
          <div
            className={`flex flex-col gap-2 p-3 flex-1 min-h-[200px] transition-colors rounded-b-xl ${
